...
export const VERIFICATION_STEPS: VerificationStep[] = [
  ...
  { label: 'task claim service', command: 'npx', args: ['tsx', '--test', 'tests/server/taskClaimService.test.ts'], stage: 1, parallelSafe: false },
  { label: 'task claim routes', command: 'npx', args: ['tsx', '--test', 'tests/server/taskRouteModules.test.ts'], stage: 1, parallelSafe: false },
  { label: 'task claim contract', command: 'npx', args: ['tsx', '--test', 'tests/server/taskClaimContract.test.ts'], stage: 1, parallelSafe: false },
  { label: 'board loop skill registry', command: 'npx', args: ['tsx', '--test', 'tests/server/skillsRegistrySeed.test.ts'], stage: 1, parallelSafe: false },
  { label: 'board loop skill content', command: 'npx', args: ['tsx', '--test', 'tests/server/authoringSkillContent.test.ts'], stage: 1, parallelSafe: false },
  { label: 'task claim card ui', command: 'npx', args: ['tsx', '--test', 'tests/taskCardClaimUi.test.ts'], stage: 1, parallelSafe: false },
