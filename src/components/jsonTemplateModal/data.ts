...
export const SIDEBAR_METHOD_COLORS: Record<string, string> = {
...
export const PANE_METHOD_COLORS: Record<string, string> = {
...
export const jsonString = JSON.stringify(sampleJson, null, 2);
...
export const apiSpecsWithIds = apiGroups.flatMap((group, groupIndex) => 
