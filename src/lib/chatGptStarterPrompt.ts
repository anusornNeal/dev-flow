export function buildChatGptStarterPrompt() {
  return [
    ...
    '3. For Jira-originated card authoring, call get_jira_authoring_bundle before individual jira_get_* proxy tools.',
    '4. For card authoring, call get_repo_inspection_index with screen/string/Jira terms before broad file search.',
    '5. Use list_local_files, search_local_files, and read_local_file with startLine/endLine/maxBytes before remote GitHub/Jira reads unless the user explicitly asks for remote data.',
    '6. Prefer get_agent_task_context for a specific card, and list_tasks/search_tasks for finding cards.',
    '',
    ...
    '2. Use create_task, update_task, move_task_status, or batch tools with responseMode summary or ack.',
